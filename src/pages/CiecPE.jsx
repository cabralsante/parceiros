...
import CiecPELogo from '../assets/ciecpe.png'
    ...
    return (
        <AppContainer onClick={e => {
            ...
            <AppImageContainer>
                ...
                <img src={CiecPELogo} alt="Fábia Roberta Logo" />

            </AppImageContainer>
            <AppSubtitle>Dental Santé e CIEC PE juntos transformando sorrisos em felicidades</AppSubtitle>
            <AppVideoDescription>
