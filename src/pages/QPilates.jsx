...
import QPilatesLogo from '../assets/qpilates.png'
    ...
    return (
        <AppContainer onClick={e => {
            ...
            <AppImageContainer>
                ...
                <img src={QPilatesLogo} alt="+Q Pilates Logo" />

            </AppImageContainer>
            <AppSubtitle>Dental Santé e +Q Pilates juntos transformando sorrisos em felicidades</AppSubtitle>
            <AppVideoDescription>
