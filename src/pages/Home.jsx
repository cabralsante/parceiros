...
import { AppContainer, AppImageContainer, AppSubtitle, AppVideo, AppVideoDescription } from "../components/HomeStyles"
...
const Home = () => {
    ...
    return (
        <AppContainer onClick={e => {
            ...
            <AppSubtitle>Dental Santé e PARCEIROS juntos transformando sorrisos em felicidades</AppSubtitle>
            <AppVideoDescription>
